...
#align(center)[
    ...
    Рисунок #pic_para Витая пара категории 6 ablexpert UPC-6055-4-CU
]
...
#body_text[
    ...
    Фото Монитора для программистов показано на рисунке #pic_monitor
]
...
#align(center)[
    ...
    Рисунок #pic_monitor Мониторы DEXP DF24H1UC для программистов
]
