...
#num_sub_head[
    Коммутационный шкаф, витая-пара, патч-панели и кабельный лоток
]
...
#body_text[
    Для размещения сетевого оборудования выбран настенный шкаф высотой 17U (модель Lanmaster Pro TWT-CBWPG-15U-6x8-GY). Шкаф изготовлен из металла, имеет стандартную ширину 19 дюймов и полезную глубину от 700 мм, что достаточно для установки сетевого оборудования. Для аккуратной организации кабельной системы используются патч-панели, которые предотвращают спутывание проводов. Для размещения кабеля для камер и для точек доступа будут использоваться кабельные лотки модели LML 500Н80. Размещение сетевого оборудования в телекомуникационном шкафу показано на рисунке #pic_closer Фото телекомуникационного шкафа показано на рисунке #pic_closer_photo, фото патч-пенели ExeGate EPP3-19-24-8P8C-C6-110D.19 показано на рисунке #pic_patch, фото бухты витой пары Cablexpert UPC-6055-4-CU показано на рисунке #pic_para, фото кабельного лотка показано на рисунке #pic_stair
]
...
#align(center)[
    ...
    Рисунок #pic_stair Кабельный лоток LML 500Н80
]
...
#body_text[
    Коммутатор распределения: MikroTik CRS326-24P-4S+RM.
    Данное устройство выполняет роль уровня распределения (Distribution Layer) в сети. Оно агрегирует трафик от коммутаторов доступа, а также обеспечивает подключение ключевых элементов инфраструктуры, которым не требуется питание по PoE. Фото коммутатора показано на рисунке #pic_switch_access
    Основные особенности:
]
...
#dash_list[
    ...
    - Подключение служебного оборудования: оставшиеся гигабитные порты применяются для подключения сетевого видеорегистратора (NVR), а также оставлены с резервом под расширение инфраструктуры — например, для сервера мониторинга (Zabbix).
]
...
#body_text[
    Коммутатор распределения: MikroTik CRS328-24G-2S+RM.
...
#dash_list[
    ...
    - Производительность и надёжность: бюджет PoE составляет 450 Вт, что с запасом покрывает пиковые нагрузки всех подключенных устройств (камеры потребляют , точки доступа максимум 28 вт). Коммутатор поддерживает аппаратное ускорение (Switch Chip), что позволяет обрабатывать трафик между VLAN на линейной скорости без дополнительной нагрузки на центральный процессор.
]

#let pic_switch_distribute = pic_cap("switch_distribute")

#body_text[
    Фото коммутатор показано на рисунке #pic_switch_distribute
]
...
#dash_list[
    ...
    - Бизнес-отдел — не требуют высокой вычислительной мощности, их работа связана преимущественно с CRM-системами, документами, таблицами и веб-интерфейсами. Для них выбраны ноутбуки OSiO FocusLine F140I-006 (16 ГБ ОЗУ, 512 ГБ SSD, предустановленная Windows 11) как наиболее экономичное и достаточное решение — 11 единиц.
]

#body_text[
    Для организации комфортной двухэкранной рабочей среды дизайнерам и фронтенд разработчикам предоставляются внешние мониторы.
]
...
#let pic_windows_noyt = pic_cap("pic_computer")
#let pic_monitor = pic_cap("pic_monitor")


#body_text[
    Предложенное решение обеспечивает мобильность сотрудников (софтфон всегда в устройстве), экономию бюджета, и возможность полноценной работы из дома.
    Фото Macbook Air показано на рисунке #pic_macbook
    Фото ноутбука для бизнес-отдела показано на рисунке #pic_windows_noyt
    Фото Монитора для дизайнеров и фронтендеров показано на рисунке #pic_monitor
]

#align(center)[
    #image("../media/MACBOOK.png", height: 20%)
    Рисунок #pic_macbook MacBook Air 13 16/256 m2, 24/512 m3
]

#align(center)[
    #image("../media/WINDOWS_NOYT.png", height: 25%)
    Рисунок #pic_windows_noyt Ноутбук для бизнес-отдела. 16/512, i3-1215U (12 поколение)
]

#align(center)[
    #image("../media/MONITOR.png", height: 25%)
    Рисунок #pic_monitor Мониторы DEXP DF24H1UC для дизайнеров и фронтенд-разработчиков
]
